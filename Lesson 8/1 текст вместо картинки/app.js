...
btn.forEach(function (clickButton) {
...
function showMoreText(card) {
    ...
    let text = 'Произвольный текст Произвольный текст Произвольный текст Произвольный текст Произвольный текст Произвольный текст';
